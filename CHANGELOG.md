...
- Cap query nesting depth and phrase expansion to prevent backend crashes ([#37](https://github.com/elemdiscovery/proxquery/pull/37))

## [0.5.1](https://github.com/elemdiscovery/proxquery/compare/v0.5.0...v0.5.1) - 2026-07-01

### Fixed

- Release asset cleanup. ([#31](https://github.com/elemdiscovery/proxquery/pull/31))
...
## [0.4.2](https://github.com/elemdiscovery/proxquery/compare/v0.4.1...v0.4.2) - 2026-06-29

### Fixed

- Max position <!~N> no longer applies as an exclusion.

## [0.4.1](https://github.com/elemdiscovery/proxquery/compare/v0.4.0...v0.4.1) - 2026-06-29
